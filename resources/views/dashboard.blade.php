<x-app-layout>
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <!-- Welcome Banner -->
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-lg p-6 sm:p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="space-y-2 text-center md:text-left">
                ...
                @else
                    <div class="mt-4 inline-flex items-center px-3 py-1 rounded-md bg-white/10 text-blue-50 border border-white/20 text-sm backdrop-blur-sm">
            ...
            <div class="hidden md:block">
                <div class="bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/20 text-center">
                    <div class="text-xs uppercase tracking-widest font-bold text-blue-200 mb-1">Hari Ini</div>
                    <div class="text-2xl font-black">{{ $namaHari }}</div>
                    <div class="text-sm font-medium text-blue-100">{{ \Carbon\Carbon::parse($today)->translatedFormat('d F Y') }}</div>
                </div>
            </div>
        </div>
