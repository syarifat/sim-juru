            ...
            <form action="{{ route('admin.tahun-ajaran.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="tahun" id="tahun" value="{{ old('tahun') }}" placeholder="Contoh: 2023/2024" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow @error('tahun') border-red-500 @enderror" required>
                        @error('tahun')
