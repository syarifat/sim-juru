        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100" x-data="{ currentRole: '{{ old('role', 'Guru') }}' }">
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="username" id="username" value="{{ old('username') }}" placeholder="Contoh: nip_guru atau nama_admin" class="w-full text-sm border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500">
                ...
                <div x-show="currentRole !== 'Admin'" x-transition:enter="transition ease-out duration-200" class="space-y-5 bg-gray-50/70 p-4 rounded-lg border border-gray-100">
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}" placeholder="Contoh: Budi Santoso, S.Pd." class="w-full text-sm border border-gray-300 bg-white rounded-lg focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip" id="nip" value="{{ old('nip') }}" placeholder="Contoh: 19820311..." class="w-full text-sm border border-gray-300 bg-white rounded-lg focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="password" name="password" id="password" class="w-full text-sm border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="pt-4 flex justify-end space-x-3 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-colors">Simpan Pengguna</button>
                </div>
            </form>
        </div>
    </div>
