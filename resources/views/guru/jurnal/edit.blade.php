        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('guru.jurnal.update', $jurnal) }}" method="POST" class="p-6 md:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="materi_pembelajaran" id="materi_pembelajaran" rows="4" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Tuliskan materi yang diajarkan hari ini secara rinci..." required>{{ old('materi_pembelajaran', $jurnal->materi_pembelajaran) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="catatan_tambahan" id="catatan_tambahan" rows="3" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Misal: Ada 2 siswa yang izin, atau PR di halaman 40...">{{ old('catatan_tambahan', $jurnal->catatan_tambahan) }}</textarea>
